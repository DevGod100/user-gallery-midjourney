...
(async () => {
  ...
  await page.goto("https://www.midjourney.com"); // The discord channel / App Authorization that you want to log into Discord for...
 
  console.log("Successfully logged in...");

  await page.waitForTimeout(50000); // Wait for page to load
